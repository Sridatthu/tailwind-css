...
export const SvgLines = () => {
  return (
    <motion.div
    whileHover="animate"
    className='w-full max-w-md rounded-md  flex items-center justify-between'>
        <div className='flex flex-col justify-between gap-8'>
            <div className='relative text-[10px]'>
                Meeting Summarizer
                <TopSVG className='absolute left-34 top-2' />
            </div>
            <div className='relative text-[10px]'>
                 Div Centerer
                 <MiddleSVG className='absolute top-2 left-30'/>
            </div>
            <div className='relative text-[10px]'>
                 Junior Intern
                 <BottomSVG  className='absolute -top-6 left-30'/>
            </div>   
        </div>
         <div className='size-10 rounded-md z-20 relative overflow-hidden p-px translate-x-6 bg-neutal-100 '>
                <div className='w-full h-full relative z-20 bg-white rounded-[3px] flex items-center justify-center'>
                    <SVG />
                </div>
                <div className='absolute h-full w-full inset-0 [background-image:conic-gradient(at_center,transparent,var(--color-blue-500)_20%,transparent_30%)] animate-spin scale-[1.4] [animate-duration:6s]'></div>
                <div className="absolute h-full w-full inset-0 [background-image:conic-gradient(at_center,transparent,var(--color-red-500)_20%,transparent_30%)] animate-spin scale-[1.4] [animate-delay:2s] [animate-duration:6s]"></div>
            </div>
    </motion.div>
  )
}
...
// here stroke has to match with defs id and u can use it where stop offset we can set color to it
